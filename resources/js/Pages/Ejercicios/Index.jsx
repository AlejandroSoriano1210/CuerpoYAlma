            ...
            <div className="py-12 bg-gray-50 min-h-screen">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600">Gestiona el catálogo de ejercicios disponibles en el gimnasio</p>
                    </div>
                                ...
                                {ejercicios.data.map((e) => (
                                    <div key={e.id} className="bg-white rounded-xl shadow-sm hover:shadow-md transition border border-gray-100 p-6 flex flex-col">
                                        ...
                                        <div className="flex items-center gap-2 pt-4 border-t border-gray-100">
                                            <Link href={route('ejercicios.show', e.id)} className="flex-1 text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition text-sm">
                                                Ver
                                            </Link>
                                            <Link href={route('ejercicios.edit', e.id)} className="bg-yellow-100 hover:bg-yellow-200 text-yellow-800 font-semibold py-2 px-4 rounded-lg transition text-sm">
                                                ✎ Editar
                                            </Link>
                                        </div>
                                    </div>
