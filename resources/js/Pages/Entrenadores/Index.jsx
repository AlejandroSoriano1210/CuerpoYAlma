...
export default function Index({ entrenadores, search: initialSearch }) {
                    ...
                    <div className="bg-white shadow rounded-lg overflow-hidden">
                        {entrenadores.length > 0 ? (
                            ...
                            <div className="p-8 text-center text-gray-500">
                                <p className="text-lg">
                                    {initialSearch ? 'No se encontraron entrenadores que coincidan con la búsqueda' : 'No hay entrenadores registrados'}
                                </p>
                            </div>
                        )}
                    </div>
